...
RDBMS is the system, SQL lamnguage used to manage the db.

1. Why do tables need a `primary key`?
primary keys help identify each record and that way if there are two of the same fields in a table, youll know the difference with their PK.
